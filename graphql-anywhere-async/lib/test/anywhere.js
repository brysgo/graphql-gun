...
describe('graphql anywhere', function () {
    ...
    it('works with promises', function () { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        var resolver, input, query, result, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    resolver = function (fieldName, root, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, root];
                                case 1: return [2, (_a.sent())[info.resultKey]];
                            }
                        });
                    }); };
                    input = {
                    ...
                    query = (_a = ["\n      {\n        arrayWithSomePromises {\n          name\n          description {\n            ...dfrag\n          }\n        }\n      }\n\n      fragment dfrag on X {\n        crazy\n      }\n    "], _a.raw = ["\n      {\n        arrayWithSomePromises {\n          name\n          description {\n            ...dfrag\n          }\n        }\n      }\n\n      fragment dfrag on X {\n        crazy\n      }\n    "], graphql_tag_1.default(_a));
                    return [4, src_1.default(resolver, query, input, null, null)];
                case 1:
                    result = _b.sent();
                    chai_1.assert.deepEqual(result, {
                        arrayWithSomePromises: [
